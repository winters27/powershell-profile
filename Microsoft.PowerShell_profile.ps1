...
sriracha - Runs the Sriracha Tool script from Sriracha Gang.
...
function Start-Neofetch {
    if (Get-Command neofetch -ErrorAction SilentlyContinue) {
        neofetch
    } else {
        Write-Host "Neofetch is not installed. Installing it now..."
        if (Get-Command winget -ErrorAction SilentlyContinue) {
            winget install neofetch
            if ($?) {
                Write-Host "Neofetch installed successfully. Running Neofetch..."
                neofetch
            } else {
                Write-Host "Failed to install Neofetch. Please install it manually."
            }
        } else {
            Write-Host "Winget is not available. Please install Neofetch manually."
        }
    }
}

# Add this line at the very end of your profile to run Neofetch on startup
Start-Neofetch
